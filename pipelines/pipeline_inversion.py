# Copyright 2024 The Cinemo Team and The HuggingFace Team. All rights reserved.
#
...
class VideoGenInversionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        motion_bucket_id = torch.tensor([motion_bucket_id], dtype=latents.dtype, device=latents.device)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latents, _ = self.next_step(noise_pred, t, latents, verbose=False)
