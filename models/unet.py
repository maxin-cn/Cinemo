...
class UNet3DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        if addition_embed_type == "motion_ids": # we need this in our situation
            ...
            print("Not use any addition embed type!")
        ...
        # clip image preject
        # self.clip_img_proj = nn.Linear(768, 768, bias=True)
        # self.add_time_proj_silu = nn.SiLU()
    ...
    def forward(
        ...
        encoder_img_hidden_states: Optional[torch.Tensor] = None,
        class_labels: Optional[torch.Tensor] = None,
        timestep_cond: Optional[torch.Tensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
        base_content: Optional[torch.Tensor] = None,
        cross_attention_kwargs: Optional[Dict[str, Any]] = None,
        added_motion_ids: Optional[Dict[str, Any]] = None,
        ...
        if self.config.addition_embed_type == "motion_ids": # we are here
